...
{   
    ...
    private IEnumerator Post(string s1, string s2, string s3, string s4, string s5)
    {
    ...
    public void Send(string a, string b, string c, string d, string e)
    {
        StartCoroutine(Post(a, b, c, d, e));
    }
